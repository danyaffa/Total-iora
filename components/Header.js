      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="flex items-center gap-4 sm:gap-6 text-sm font-medium text-slate-600">
            <Link href="/get-your-aura" className="hover:text-slate-900 transition-colors">
              Begin
            </Link>
            <Link href="/sacred-space" className="hover:text-slate-900 transition-colors">
              Sacred Notes
            </Link>
            <Link
              href="/unlock"
              className="bg-slate-800 text-white px-4 py-2 rounded-full hover:bg-slate-700 transition-colors"
            >
              Support
            </Link>
          </nav>
